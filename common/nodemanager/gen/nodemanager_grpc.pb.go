...
func (c *nodeManagerClient) GetRuntimeConfig(ctx context.Context, in *GetRuntimeConfigRequest, opts ...grpc.CallOption) (*GetRuntimeConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeManager_GetRuntimeConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeManagerClient) GetHostEvents(ctx context.Context, in *GetHostEventsRequest, opts ...grpc.CallOption) (*GetHostEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeManager_GetHostEvents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nodeManagerClient) ListNodeCapacity(ctx context.Context, in *ListNodeCapacityRequest, opts ...grpc.CallOption) (*ListNodeCapacityResponse, error) {
	...
	err := c.cc.Invoke(ctx, NodeManager_ListNodeCapacity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
