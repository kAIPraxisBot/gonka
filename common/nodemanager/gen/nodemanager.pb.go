...
type AcquireMLNodeRequest struct {
	...
	// Optional client session id (from the request's prompt_cache_key). When set,
	// the broker prefers this session's last mlnode for KV-cache reuse.
...
func (x *AcquireMLNodeRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
